      ...
      <div className="mini-posts">
        <article>
          <a href="https://skills-hub.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/skills.png" alt="A serene setup with a developer exploring technology stacks" />
          </a>
        ...
        <article>
          <a href="https://code-review.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/code-review.png" alt="A calm workspace with a developer reviewing code" />
          </a>
        ...
        <article>
          <a href="https://www.physics-calculator.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/physics-calc.png" alt="A minimal workspace with a computer showing a blank screen" />
          </a>
        ...
        <article>
          <a href="https://www.physics-flashcards.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/flashcards.png" alt="A workspace featuring physics-themed diagrams" />
          </a>
        ...
        <article>
          <a href="https://retro-monitor.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/retro.png" alt="A vintage-inspired workspace with a retro typewriter" />
          </a>
        ...
        <article>
          <a href="https://animalguesses.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/animalguesses.png" alt="A workspace featuring animal-themed art" />
          </a>
        ...
        <article>
          <a href="https://www.emf-simulator.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/emf.png" alt="A visualization of a physics simulator" />
          </a>
        ...
        <article>
          <a href="https://tetris2.0.raimonvibe.com/" target="_blank" className="image">
            <img src="/images/tetris.png" alt="A minimalist visualization of a Tetris game interface" />
          </a>
          <h3>Tetris 2.0</h3>
          ...
          <div className="mini-posts">
            <article>
              <a href="https://periodic-table.raimonvibe.com/" target="_blank" className="image">
                <img src="/images/periodic-table.png" alt="An interactive periodic table" />
              </a>
            ...
            <article>
              <a href="https://inventory-pro.raimonvibe.com/" target="_blank" className="image">
                <img src="/images/inventory.png" alt="A sleek interface showcasing inventory tracking" />
              </a>
              <h3>Inventory Pro</h3>
            ...
            <article>
              <a href="https://google-login-edu.raimonvibe.com/" target="_blank" className="image">
                <img src="/images/google.png" alt="A Google Login EDU interface" />
              </a>
