        ...
        <div className="inner">
          ...
          <section>
            ...
            <div className="posts">
              ...
              <article>
                <a href="https://codewithmosh.com/p/html-css-tutorial" className="image">
                  <Image src="/images/HTML_CSS.webp" alt="My HTML and CSS certificate" width={400} height={300} />
                </a>
                <h3>HTML and CSS</h3>
                <p>In this course, I learned the fundamentals of web development with HTML and CSS, including responsive design and modern web standards.</p>
              </article>
              ...
              <article>
                ...
                <p>This course provided me with the fundamental concepts and problem-solving skills needed before diving into specific programming languages.</p>
              </article>
              ...
              <article>
                ...
                <h3>JavaScript 1</h3>
                <p>In JavaScript Part 1, I learned the basics of programming in JavaScript. The course content includes variables, arrays, functions, and objects.</p>
              </article>
              ...
              <article>
                ...
                <h3>JavaScript 2</h3>
                <p>In JavaScript Part 2, I learned more advanced programming concepts. The course content includes Object-Oriented Programming.</p>
              </article>
