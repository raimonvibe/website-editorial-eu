            ...
            <div className="posts">
              <article className="common-properties-left">
                <a href="https://www.collabs.io/mag/raimonvibe/" className="image">
                  <Image src="/images/pic17.jpg" alt="My company in the online magazine Collabs" width={400} height={300} />
                </a>
              ...
              <article className="common-properties-right">
                <a href="https://techbullion.com/is-software-development-a-dead-end-job-after-age-35/" className="image">
                  <Image src="/images/pic18.jpg" alt="My company in the online magazine TechBullion" width={400} height={300} />
                </a>
