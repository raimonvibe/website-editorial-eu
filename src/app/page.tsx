        ...
        <div className="inner">
          ...
          <section>
            ...
            <div className="features">
              <article>
                <span className="icon"><FontAwesomeIcon icon={faGem} style={{color: '#f56a6a', fontSize: '3.5rem', transform: 'scale(1.2)'}} /></span>
                <div className="content">
              ...
              <article>
                <span className="icon"><FontAwesomeIcon icon={faPaperPlane} style={{color: '#f56a6a', fontSize: '3.5rem', transform: 'scale(1.2)'}} /></span>
                <div className="content">
                  <h3>Technological Impact</h3>
              ...
              <article>
                <span className="icon"><FontAwesomeIcon icon={faRocket} style={{color: '#f56a6a', fontSize: '3.5rem', transform: 'scale(1.2)'}} /></span>
                <div className="content">
                  <h3>Technological Impact</h3>
              ...
              <article>
                <span className="icon"><FontAwesomeIcon icon={faSignal} style={{color: '#f56a6a', fontSize: '3.5rem', transform: 'scale(1.2)'}} /></span>
                <div className="content">
                  <h3>Skills</h3>
