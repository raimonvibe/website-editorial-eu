...
import { faGem, faPaperPlane, faRocket, faSignal } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="inner">
          ...
          <section>
            ...
            <div className="features">
              <article>
                <span className="icon"><FontAwesomeIcon icon={faGem} /></span>
                <div className="content">
              ...
              <article>
                <span className="icon solid"><FontAwesomeIcon icon={faPaperPlane} /></span>
                <div className="content">
                  <h3>Technological Impact</h3>
              ...
              <article>
                <span className="icon solid"><FontAwesomeIcon icon={faRocket} /></span>
                <div className="content">
                  <h3>Technological Impact</h3>
              ...
              <article>
                <span className="icon solid"><FontAwesomeIcon icon={faSignal} /></span>
                <div className="content">
                  <h3>Skills</h3>
